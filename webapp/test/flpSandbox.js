		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#combmchcmdrfzhcmuxdrf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combmchcmdrfzhcmuxdrf-display": {
								"semanticObject": "combmchcmdrfzhcmuxdrf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bmc.hcm.drf.zhcmuxdrf",
									"url": sap.ui.require.toUrl("com/bmc/hcm/drf/zhcmuxdrf")
								}
							}
						}
					}
